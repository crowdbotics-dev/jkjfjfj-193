"""
Django settings for jkjfjfj_193 project.
...
WSGI_APPLICATION = 'jkjfjfj_193.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "jkjfjfj_193 API",
    "DESCRIPTION": "API documentation for jkjfjfj_193 App",
    "VERSION": "v1",
}
